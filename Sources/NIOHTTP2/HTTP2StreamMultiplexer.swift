...
public final class HTTP2StreamMultiplexer: ChannelInboundHandler, ChannelOutboundHandler {
    ...
    public func channelRead(ctx: ChannelHandlerContext, data: NIOAny) {
        ...
        if let channel = streams[streamID] {
            ...
            let channel = HTTP2StreamChannel(allocator: self.channel!.allocator, parent: self.channel!, streamID: streamID)
    ...
    public func userInboundEventTriggered(ctx: ChannelHandlerContext, event: Any) {
        ...
        channel.receiveStreamIsClosed(evt.reason)
    }
...
extension HTTP2StreamMultiplexer
{
    ...
    public func createStreamChannel(promise: EventLoopPromise<Channel>?,
